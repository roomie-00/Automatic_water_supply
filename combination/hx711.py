...
class HX711:
    ...
    def get_data_mean(self, readings=30):
        ...
        """
        result = self.get_raw_data_mean(readings)
        print("get_data_mean 속 result 값 : ", result )
        print("get_data_mean 속 channel : ", self._current_channel)
        print("get_data_mean 속 channel_A : ", self._gain_channel_A)
        print("get_data_mean 속 offset_A_128 : ", self._offset_A_128)
        if result != False:
            if self._current_channel == 'A' and self._gain_channel_A == 128:
